...
/** Site Supervisor job marketplace matching the Carpenter job-role interface. */
public class SiteSupervisorJobRolesPage {
    private static final String[] HERO_IMAGES = {
            "/assets/images/worker/foreman/skill-00.jpg", "/assets/images/worker/foreman/skill-01.jpg",
    ...
    public Scene getScene(Runnable back) {
        return getSiteSupervisorJobRolesScene(back);
    }

    public Scene getSiteSupervisorJobRolesScene(Runnable back) {
    ...
    private VBox hero() {
        Label title = label("Site Supervisor Job Roles",
        ...
        Label quote = label("“Great structures rise not just from bricks and mortar, but from clear vision, steady guidance, and dedication.”",
    ...
    private VBox filter() {
        ComboBox<String> state = combo("All States", "Maharashtra", "Karnataka", "Tamil Nadu", "Delhi", "Telangana", "Haryana");
        ComboBox<String> city = combo("All Cities", "Pune", "Mumbai", "Nashik", "Bangalore", "New Delhi", "Chennai", "Hyderabad", "Gurgaon", "Bhiwandi");
        ComboBox<String> skill = combo("All Roles", "Foreman", "Safety Supervisor", "Quality Inspector", "General Supervisor", "Material Supervisor", "Site Engineer", "Project Coordinator", "Construction Supervisor", "Shift Incharge");
        ...
        VBox box = new VBox(14,
                label("Find a suitable site supervisor job role for you",
    ...
    private VBox card(String[] j) {
        ...
        if (imgPath != null && imgPath.matches("\\d+")) {
            imgPath = String.format("/assets/images/worker/foreman/skill-%s.jpg", j[3]);
        }
    ...
    private ImageView image(String path, double width, double height) {
        ...
        Image img = load(path);
        if (img == null) {
            img = load("/assets/images/worker/foreman/skill-00.jpg");
        }
        view.setImage(img);
