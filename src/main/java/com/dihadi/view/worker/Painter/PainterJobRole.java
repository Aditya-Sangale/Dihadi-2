...
/** Painter job marketplace matching the Carpenter job-role interface. */
public class PainterJobRole {
    private static final String[] HERO_IMAGES = {
            "/assets/images/worker/painter/skill-00.jpg", "/assets/images/worker/painter/skill-01.jpg",
    ...
    private VBox hero() {
        Label title = label("Painter Job Roles",
        ...
        Label quote = label("“Transforming spaces with precision, color, and craft across residential and commercial sites.”",
    ...
    private VBox filter() {
        ComboBox<String> state = combo("All States", "Maharashtra", "Karnataka", "Tamil Nadu", "Delhi");
        ComboBox<String> city = combo("All Cities", "Pune", "Mumbai", "Bangalore", "New Delhi", "Chennai");
        ComboBox<String> skill = combo("All Skills", "Interior", "Exterior", "Texture", "Spray", "Putty", "Polish");
        ...
        VBox box = new VBox(14,
                label("Find a suitable painter job role for you",
    ...
    private VBox card(String[] j) {
        ...
        if (imgPath != null && imgPath.matches("\\d+")) {
            imgPath = String.format("/assets/images/worker/painter/skill-%s.jpg", j[3]);
        }
    ...
    private ImageView image(String path, double width, double height) {
        ...
        Image img = load(path);
        if (img == null) {
            img = load("/assets/images/worker/painter/skill-00.jpg");
        }
        view.setImage(img);
