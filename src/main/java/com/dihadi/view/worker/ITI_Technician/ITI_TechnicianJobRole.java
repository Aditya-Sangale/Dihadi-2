...
/** ITI/Technician job marketplace matching the Carpenter job-role interface. */
public class ITI_TechnicianJobRole {
    private static final String[] HERO_IMAGES = {
            "/assets/images/worker/iti/skill-01.jpg", "/assets/images/worker/iti/skill-02.jpg",
    ...
    private VBox hero() {
        Label title = label("ITI Technician Job Roles",
        ...
        Label quote = label("“Certified technical precision driving next-generation infrastructure across industrial and residential zones.”",
    ...
    private VBox filter() {
        ...
        ComboBox<String> city = combo("All Cities", "Pune", "Mumbai", "Nashik", "Bangalore South", "New Delhi", "Chennai");
        ComboBox<String> skill = combo("All Skills", "Fitter", "Machinist", "Turner", "Welder", "Mechanic", "Electrician");
        ...
        VBox box = new VBox(14,
                label("Find a suitable ITI technician job role for you",
