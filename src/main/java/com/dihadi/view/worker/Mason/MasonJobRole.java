...
/** Mason job marketplace matching the Carpenter job-role interface. */
public class MasonJobRole {
    private static final String[] HERO_IMAGES = {
            "/assets/images/worker/mason/hero.jpg", "/assets/images/worker/mason/skill-01.jpg",
    ...
    private VBox hero() {
        ...
        Label quote = label("“Building enduring foundations with skilled brick, stone, and tile artisans across major hubs.”",
    ...
    private VBox filter() {
        ...
        ComboBox<String> city = combo("All Cities", "Pune", "Mumbai", "Nashik", "Bangalore", "New Delhi", "Chennai");
        ComboBox<String> skill = combo("All Skills", "Brick Mason", "Stone Mason", "Concrete Finisher", "Tilesetter", "Refractory", "Terrazzo");
        ...
        VBox box = new VBox(14,
                label("Find a suitable mason job role for you",
    ...
    private VBox card(String[] j) {
        ...
        if (imgPath != null && imgPath.matches("\\d+")) {
            imgPath = String.format("/assets/images/worker/mason/skill-%s.jpg", j[3]);
        }
    ...
    private ImageView image(String path, double width, double height) {
        ...
        Image img = load(path);
        if (img == null) {
            img = load("/assets/images/worker/mason/hero.jpg");
        }
        view.setImage(img);
